...
@ComponentScan(basePackages = {
   "com.arnellconsulting.worktajm.repository"
})
@EnableJpaRepositories(basePackages = "com.arnellconsulting.worktajm.repository")
public class PersistenceContext {

   private static final String[] PROPERTY_PACKAGES_TO_SCAN = {
      "com.arnellconsulting.worktajm.model"
   };

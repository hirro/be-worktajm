...
insert into person (id, email, first_name, last_name, password, active_time_entry, email_verified) values (1, 'jim@arnellconsulting.com', 'Jim', 'Arnell', 'password', NULL, true);
insert into person (id, email, first_name, last_name, password, active_time_entry, email_verified) values (2, 'jonna@arnellconsulting.com', 'Jonna', 'Arnell', 'password', NULL, false);

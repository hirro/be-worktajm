package com.worktajm.config;

import com.worktajm.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.worktajm.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.worktajm.repository.search")
